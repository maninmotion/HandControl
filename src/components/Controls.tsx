...
const TIME_SIGNATURES: TimeSignature[] = ['4/4', '3/4', '2/4', '5/4', '7/4', '6/8', '9/8'];
...
export const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="controls two-row">
      {/* Top Row: Play/Pause, Reset, BPM, Volume, Click */}
      ...
      {/* Bottom Row: Time, Note Value, Repeats, Mode, Pattern */}
      <div className="controls-row">
